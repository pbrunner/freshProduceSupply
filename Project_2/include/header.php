...
<div class="headerattrib"><small>Image taken from <a href="https://morguefile.com/">MorgueFile</a> free photo archive by Kconnors</small></div>
	</div>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    <li class="dropdown nav-item">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="./ingredients.php">Ingredients <span class="caret"></span></a>
						...
						<?php
							...
							{
								echo "<li class='nav-item'><a href='./ingredients.php?i=$item'>$item</a></li>";
							}
						?>
                        </ul>
