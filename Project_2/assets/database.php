...
class Database extends PDO {
	...
	function getIngredient($query_term) {
		...
		$sql = "SELECT ingredient_id, ingredient_name, image_filename, image_attribution, description FROM ingredients
	...
	{
		$db = new Database();
		$sql_ingredient = "INSERT INTO ingredients (ingredient_name, image_filename, image_attribution, description) VALUES (:ingredient_name, :image_filename, :image_attribution, :description)";
