...
if(isset($_POST['unit'])){
  ...
  if($unit == "")
    $errors .= 'Please enter units for your ingredient.<br>';
}

if(isset($_POST['cost'])){
  $cost = filter_var($_POST['cost'], FILTER_SANITIZE_STRING);
  if($cost == "")
    $errors .= 'Please enter a price for your ingredient.<br>';
}

if(isset($_POST['short'])){
  $short = filter_var($_POST['short'], FILTER_SANITIZE_STRING);
  if($short == "")
    $errors .= 'Please enter short for your ingredient.<br>';
}

if(isset($_POST['time'])){
  $time = filter_var($_POST['time'], FILTER_SANITIZE_STRING);
  if($time == "")
    $errors .= 'Please enter a shipping time for your ingredient.<br>';
}
if(empty($errors)){
      ...
      if ($ext == '') {
        ...
        if ($fid == - 1) {
          ...
          if(empty($error_msg)){
            ...
            chmod($path, 0644);
            $ingredient = new Ingredient($name, $db->getLastIngredientID()+1,$_FILES["image"]["name"], $attr_name, $content, $unit, $cost, $short, $time);
            ...
            <form method="post" enctype="multipart/form-data" class="form-inline" style="text-align: center">
              <div class="form-group">
                ...
                <label class="sr-only" for="image">Upload Image</label>
                  ...
                  <br><br>
                  <p style="text-align: center">Input the short of the ingredient:</p>
                  <input type="text" class="form-control" name="short"/>
                  <br><br>
                  <p style="text-align: center">Input the unit of the ingredient:</p>
                  <input type="text" class="form-control" name="unit"/>
                  <br><br>
                  <p style="text-align: center">Input the cost of the ingredient:</p>
                  <input type="text" class="form-control" name="cost"/>
                  <br><br>
                  <p style="text-align: center">Input the time of the ingredient:</p>
